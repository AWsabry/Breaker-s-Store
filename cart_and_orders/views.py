    ...
    if request.user.is_authenticated:
        ...
        if cartItemschecking != None:
            ...
            periodic_time = cartItemschecking.created + \
                timedelta(days=0, hours=0, minutes=10, seconds=0)
...
# Sending Payment via API
        ...
        sending_payment_request = requests.post('https://sandboxapi.opaycheckout.com/api/v1/international/cashier/create', headers={
            ...
            "returnUrl": "https://a91f-41-45-217-17.ngrok.io/order_confirm",
            "cancelUrl": "https://a91f-41-45-217-17.ngrok.io/PaymentFailed",  # Payment Failed
            "callbackUrl": "https://a91f-41-45-217-17.ngrok.io/callbackurl",
            "expireAt": 300,
            "userInfo": {
